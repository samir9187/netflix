// Consts
const apikey = "eb0c4c0de6e5aa9f35ebed7145a55a57";
...
const apiPaths = {
  ...
  searchOnYoutube: (query) =>
    `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyCImbXTUZxyzG04gjeh19zqTdLn90rWV14`,
};
...
function buildBannerSection(movie) {
  ...
  const title = movie.title || "Title Not Available"; // Handling undefined title
  const release_date = movie.release_date || "Release Date Not Available"; // Handling undefined release date
  div.innerHTML = `
            <h2 class="banner__title">${title} </h2>
            <p class="banner__info">Trending in movies | Released - ${release_date} </p>
